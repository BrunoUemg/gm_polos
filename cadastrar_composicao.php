...
$cpfAluno_composicao = $_GET['cpfAluno_composicao'];
...
<center><div class="card-title">Composição familiar de <?php echo $linha['nomeAluno']?></div></center>
                  ...
                  <tbody>
                    ...
                    <?php while ($rows_consultaComposicao = mysqli_fetch_assoc($resultado_consultaComposicao)) {
                      ...
                      <tr>
                        ...
                        <?php  echo "<a  class='btn btn-default' title='Excluir' href='remover_integrante.php?idComposicao_familiar=" .$rows_consultaComposicao['idComposicao_familiar']. "' onclick=\"return confirm('Tem certeza que deseja deletar esse registro?');\">"?> <i class='fas fa-trash-alt'></i><?php echo "</a>";  ?>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <form action="alterar_composicao.php" method="POST">
                                    ...
                                    <label>Renda</label>
                                    <input type="text" class="form-control" required name="renda" value="<?php echo $rows_consultaComposicao['renda']; ?>" >
    ...
    <button type="submit" class="btn btn-danger" onClick="window.location.href='cadastrar_alunos.php'">Voltar</button>
    </div>
    </div>
    </div>
