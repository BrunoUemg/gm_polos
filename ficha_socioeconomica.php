  ...
  <div class="content">
    <div class="page-inner">
      <div class="page-header">
        <h4 class="page-title">Ficha Socioeconômica e Composição familiar do Aluno</h4>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="card">
                  ...
                  <tbody>
                    ...
                    <?php while ($rows_consultaAluno = mysqli_fetch_assoc($resultado_consultaAluno)) {
                      ...
                      <tr>
                        ...
                        <td><?php echo $rows_consultaAluno['composicaoFamiliar']; ?></td>
                        <td><?php echo $rows_consultaAluno['nomePolo']; ?></td>

                        <td>
                     
                          <?php echo "<a class='btn btn-default' title='Cadastra Ficha Social ' href='cadastrar_socioeconomica.php?idAluno=" . $rows_consultaAluno['idAluno'] .  "'>" ?><i class="fa fa-address-card"></i><?php echo "</a>"; ?>
                          <?php echo "<a class='btn btn-default' title='Composição familiar ' href='cadastrar_composicao.php?idAluno=" . $rows_consultaAluno['idAluno'] .  "'>" ?><i class="fa fa-users"></i><?php echo "</a>"; ?>
                          <?php echo "<a class='btn btn-default' title='Imprimir Composição familiar ' href='imprimir_composicao.php?idAluno=" . $rows_consultaAluno['idAluno'] .  "'>" ?><i class="fa fa-file-pdf"></i><?php echo "</a>"; ?>
                          <?php echo "<a class='btn btn-default' title='Ficha Social ' href='imprimir_social.php?idAluno=" . $rows_consultaAluno['idAluno'] .  "'>" ?><i class="fa fa-search"></i><?php echo "</a>"; ?>
