    ...
    <div class="page-inner">
                  ...
                  <table id="basic" class="display table table-striped table-hover">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th>Presente <input type="checkbox" name="checkAll" id="checkAll" title="Selecione Todos"></th>
                      </tr>
                    </thead>
                    <tfoot>
                      <tr>
      ...
      where L.idAluno = '$rows_consultaChamada[idAluno]' and L.idEncontro = '$rows_consultaChamada[idEncontro]'   ";
                          ...
                          <td>
                            ...
                            <input type='checkBox' class="check" name='pres[]' value="<?php echo $rows_consultaChamada['idAluno'] ?>"> </input>
                            <label for=""></label>
                            <label for=""></label>


                            <?php //echo "<a class='btn btn-success' title='Presença' href='consultar_alunos.php?id=" . $rows_consultaChamada['idAluno'] . "' data-toggle='modal' data-target='#ModalMaisInfo" . $rows_consultaChamada['idAluno'] . "'>" 
                            ?>
                            <!--Guardar--><?php //echo "</a>"; 
                                          ?>

                            <?php // echo "<a class='btn btn-success' title='Editar Presença' href='consultar_alunos.php?id=" . $rows_consultaChamada['idAluno'] . "' data-toggle='modal' data-target='#editarPresenca" . $rows_consultaChamada['idAluno'] . "'>" 
                            ?>
                            <!--<i  class="fas fa-edit"></i><?php //echo "</a>"; 
                                                            ?>
                    <?php //echo "<a class='btn btn-success' title='Sansção diciplinar' href='consultar_alunos.php?id=" . $rows_consultaChamada['idAluno'] . "' data-toggle='modal' data-target='#ModalSancao" . $rows_consultaChamada['idAluno'] . "'>" 
                    ?><i class="fa fa-exclamation-triangle"></i>--><?php //echo "</a>"; 
                                                                    ?>
                            <input type="text" readonly hidden name="idPolo" id="idPolo" class="form-control" value="<?php echo $rows_consultaChamada['idPolo']; ?>">
                            <input type="text" readonly hidden name="idMonitor" id="idMonitor" class="form-control" value="<?php if (!empty($_SESSION['idMonitor'])) {
                                                                                                                              echo $rows_consultaChamada['idMonitor'];
                                                                                                                            } else {
                                                                                                                              echo $idMonitor;
                                                                                                                            } ?>">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="envio_chamada.php" method="POST" enctype="multipart/form-data">
                          ...
                          <input type="text" readonly hidden name="idMonitor" class="form-control" value="<?php if ($_SESSION['idMonitor'] != 0) {
                                                                                                            echo $resultFinal['idMonitor'];
                                                                                                          } else {
                                                                                                            echo $idMonitorEncerramento;
                                                                                                          } ?>">
                          <input type="text" readonly name="idPolo" class="form-control" value="<?php if ($_SESSION['idMonitor'] != 0) {
                                                                                                  echo $resultFinal['idPolo'];
                                                                                                } else {
                                                                                                  echo $idPolo;
                                                                                                } ?>">
