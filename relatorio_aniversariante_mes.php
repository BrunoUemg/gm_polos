...
if(!empty($_POST['mes'])){
    $mesNiver = $_POST['mes'];
    $select_aluno = mysqli_query($con,"SELECT * FROM aluno A INNER JOIN polo P ON P.idPolo = A.idPolo");
  ...
  <div class="content">
    <div class="page-inner">
      <div class="page-header">
        <h4 class="page-title">Relatório aniversariante do mês</h4>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="card">
                ...
                <table id="basic-datatables" class="display table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    while ($rows_aluno = mysqli_fetch_assoc($select_aluno)) {
                      ...
                      <td><?php echo $rows_aluno['dtNascimento']; ?></td>
...
<script>
    ...
    $('#basic-datatables').DataTable( {
        ...
        'print',{
            extend: 'pdf',
            text: 'PDF',
            title: "Relatório aniversariante do mês <?php echo $mesNiver ?>",
            key: {
                key: 'p',
                altkey: true
            }
