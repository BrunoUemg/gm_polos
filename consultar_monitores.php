                    ...
                    <?php while ($rows_consultaMonitor = mysqli_fetch_assoc($resultado_consultaMonitor)) {
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php echo "<a class='btn btn-default' href='consultar_monitores.php?id=" . $rows_consultaMonitor['idMonitor'] . "' data-toggle='modal' data-target='#ModalMaisInfo" . $rows_consultaMonitor['idMonitor'] . "'>" ?><i class="fas fa-plus-square"></i><?php echo "</a>"; ?>
